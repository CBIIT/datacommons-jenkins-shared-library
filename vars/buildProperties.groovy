            ...
            [
                    ...
                    parameters(
                            [
                                    ...
                                    gitParameter(branch: "", branchFilter: "origin/(.*)", defaultValue: "develop", description: "Select Branch or Tag to build", name: "DeployRepoTag", quickFilterEnabled: false, selectedValue: "NONE", sortMode: "NONE", tagFilter: "*", type: "GitParameterDefinition",useRepository: config.deploymentRepoUrl),
