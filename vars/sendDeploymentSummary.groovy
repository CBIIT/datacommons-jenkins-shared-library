...
def call(Map config) {
    ...
    def project =  [type: "section",fields:[[type: "mrkdwn",text: "*Project*"],[type: "mrkdwn",text: "*${config.projectName}*"],[type: "mrkdwn",text: "*Environment*"],[type: "mrkdwn",text: "*${config.tier}*"]]]
    ...
    def blocks = [header,project,title,fields ]
...
//    icon_emoji: config.emojiIcon,
    def slackPayload = JsonOutput.toJson([blocks: blocks,attachments: attachments])
    try {
